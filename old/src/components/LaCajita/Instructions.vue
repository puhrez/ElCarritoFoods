<template>
  <section id="la-cajita-instructions">
    <article>
      <header>
        <h2>La Cajita</h2>
      ...
      <section class="program-description">
        ...
        <br>
        <h4>Instrucciones</h4>
        <p>Reservá y ordená las cajitas a través del Calendario.</p>
    ...
    <order-button v-if="!$store.getters.hasReservations"></order-button>
